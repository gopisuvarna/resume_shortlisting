...
export default function PostJobPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(extractApiErrorMessage(error, "Failed to post job."));
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <h1 className="font-display text-2xl sm:text-3xl font-bold text-slate-900 mb-6">
          Post a New Job
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <FormField label="Openings">
                <input
                  ...
                  value={form.openings}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, openings: Number(e.target.value) }))
                  }
                  className="input-hr"
                />
              </FormField>
            ...
            {([
              {
                ...
                rows: 4,
                placeholder: "Describe the role, its impact, and the team…",
              },
              {
                key: "responsibilities",
                label: "Responsibilities",
                rows: 4,
                placeholder: "Day-to-day tasks and key responsibilities…",
              },
              {
                key: "requirements",
                ...
                rows: 4,
                placeholder:
                  "Must-have qualifications, experience, certifications…",
              },
            ] as const satisfies readonly TextareaFieldConfig[]).map((f) => (
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3">
            ...
            <button
              type="submit"
              disabled={saving}
              className="btn-hr flex-1 justify-center py-3"
            >
              {saving ? (
                <>
