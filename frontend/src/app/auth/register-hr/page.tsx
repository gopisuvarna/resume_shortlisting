...
export default function HRRegisterPage() {
  ...
  return (
    <RegisterFormShell
      ...
      iconContainerClassName="inline-flex items-center justify-center w-14 h-14 bg-violet-600 rounded-2xl mb-5 shadow-lg shadow-violet-200/60"
      cardClassName="card p-7 sm:p-8"
      buttonClassName="w-full btn-hr py-3 text-base justify-center mt-1"
      signInHref="/auth/login"
      signInLabel="Already registered?"
      signInLinkClassName="text-violet-600 font-semibold hover:underline"
    ...
    >
      ...
      <div className="p-4 bg-violet-50 border border-violet-200 rounded-xl">
        <label
          htmlFor="invite_code"
          className="block text-sm font-semibold text-violet-800 mb-1.5"
        >
          Invite Code
        </label>
        <input
